...
namespace DomainLayer.Market.SearchEngine
{
	...
	/// Used from open source https://github.com/yetanotherchris/SpellingCorrector/tree/master/src
	/// </summary>
	public class Spelling
	{
		...
		public Spelling()
		{
			string dictionary = Resources.words_big;
			//string dictionary = Resources.words_alpha;
